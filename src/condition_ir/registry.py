...
from condition_ir.cel_types import CelRegistryFingerprint
...
def with_standard_synthetic_bindings(
    ...
    """Augment a registry with caller-supplied non-concept condition bindings.

    The synthetic binding vocabulary is not owned by this package: callers pass
    the names they want seeded at the boundary. With no names this is a no-op
    copy.
    """
    synthetic_concepts = [
        ...
        for canonical_name in synthetic_binding_names
