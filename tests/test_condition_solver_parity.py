...
from condition_ir.registry import ConceptInfo, KindType
from condition_ir import check_condition_ir, checked_condition_set
...
def test_condition_solver_classifies_numeric_disjointness_and_overlap() -> None:
    from condition_ir.solver import ConditionSolver
...
def test_condition_solver_rejects_unknown_closed_category_literal() -> None:
    from condition_ir.solver import ConditionSolver, Z3TranslationError
